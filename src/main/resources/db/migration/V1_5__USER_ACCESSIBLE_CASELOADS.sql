...
CREATE INDEX "USER_ACCESSIBLE_CLS_FK1" ON "USER_ACCESSIBLE_CASELOADS" ("USERNAME");


CREATE INDEX "USER_ACCESSIBLE_CLS_FK2" ON "USER_ACCESSIBLE_CASELOADS" ("CASELOAD_ID");
