...
class UserResource(
  ...
  @PreAuthorize("hasRole('ROLE_MAINTAIN_ACCESS_ROLES_ADMIN') or hasRole('ROLE_MAINTAIN_ACCESS_ROLES') or hasRole('ROLE_VIEW_NOMIS_STAFF_DETAILS') or hasRole('ROLE_NOMIS_MANAGE_USERS__USER_ACCOUNTS__RO')")
  @GetMapping
  @Operation(
