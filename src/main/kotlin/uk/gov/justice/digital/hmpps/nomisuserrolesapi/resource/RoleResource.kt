...
class RoleResource(
  ...
  @PreAuthorize("hasAnyRole('ROLES_ADMIN','ROLE_MAINTAIN_ACCESS_ROLES_ADMIN')")
  @PostMapping("")
  ...
  @PreAuthorize("hasAnyRole('ROLES_ADMIN','ROLE_MAINTAIN_ACCESS_ROLES_ADMIN', 'ROLE_MAINTAIN_ACCESS_ROLES')")
  @GetMapping
  @Operation(
