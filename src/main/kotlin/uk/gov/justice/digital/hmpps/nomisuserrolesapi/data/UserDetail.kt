...
data class UserDetail(
  ...
  @Schema(description = "List of user groups administered", required = false) val administratorOfUserGroups: List<UserGroup>,
  ...
  constructor(
    ...
    this(
      ...
      administratorOfUserGroups = userPersonDetail.administratorOfUserGroups.map { UserGroup(it.userGroup.id, it.userGroup.description) },
