...
@Schema(description = "General User Information creation")
data class CreateGeneralUserRequest(
  ...
  @Schema(description = "Default caseload (a.k.a Prison ID)", example = "BXI", required = true)
  @field:Size(
    max = 6,
    min = 3,
